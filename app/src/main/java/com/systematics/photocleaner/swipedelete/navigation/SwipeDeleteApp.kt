package com.systematics.photocleaner.swipedelete.navigation
...
import com.systematics.photocleaner.swipedelete.domain.model.LaunchDestination
import com.systematics.photocleaner.swipedelete.domain.usecase.*
import com.systematics.photocleaner.swipedelete.presentation.swipedelete.*
import com.systematics.photocleaner.swipedelete.presentation.screens.premium.PremiumScreen
import com.systematics.photocleaner.swipedelete.presentation.screens.privacy_policy.PrivacyPolicyScreen
import com.systematics.photocleaner.swipedelete.presentation.screens.splash.SplashScreen
...
fun SwipeDeleteApp(
    ...
    SwipeDeleteTheme(isDark, !appState.fullMotion, appState.haptics) {
        NavHost(navController, Routes.SplashScreenRoutes) {
            ...
            composable<Routes.OnboardingScreenRoutes> {
                SwipeDeleteOnboardingScreen(onContinue = destinations.mediaAccess, onPrivacy = destinations.privacy)
            }
            composable<Routes.MediaAccessRoutes> {
                MediaAccessScreen(onGranted = destinations.main, onSelected = destinations.selected, onDenied = destinations.denied,
                    onNotNow = destinations.main)
            }
            ...
            composable<Routes.SettingsScreenRoutes> {
                SwipeDeleteSettingsScreen(onBack = destinations.back, onLanguage = { destinations.language(false) }, onAccess = destinations.mediaAccess,
