...
class RewardedInterstitialAdManager(
    context: Context,
    adInfo: AdInfo
) : AdManager<RewardedInterstitialAd>(context, adInfo) {
        ...
        RewardedInterstitialAd.load(
            ...
            object : AdLoadCallback<RewardedInterstitialAd> {
                ...
                override fun onAdLoaded(ad: RewardedInterstitialAd) {
                    ...
                    loadState = AdLoadState.Loaded(this@RewardedInterstitialAdManager)
    ...
    override fun show(activity: Activity, adShowListener: AdShowListener) {
        mRewardedInterstitialAd?.let {
            ALog.d(TAG, "${adInfo.adTAG} showing")
            it.adEventCallback = object : RewardedInterstitialAdEventCallback {
                ...
                override fun onAdPaid(value: AdValue) {
                    ...
                    AdmobNetworkApp.instance.revenueListener.onRevenue(
                        revenueModel = AdmobRevenue(
                            ...
                            adType = AdmobAdType.REWARDED_INTERSTITIAL
                        )
                    )
                }
            }
    ...
    override fun getLoadedAd() = mRewardedInterstitialAd

    companion object {

        private const val TAG = "Admob RewardedInterstitialAdManager"
    }
}