...
class InterstitialAdsPreLoader(
    private val adUnitId: String,
    private val isAdNeeded: (String) -> Boolean,
    private val onAdPreloaded: (String, InterstitialAd) -> Unit,
    private val onAdFailed: (String, LoadAdError) -> Unit
) : AdmobPreLoader<InterstitialAd>() {
    ...
    companion object {
        ...
        private const val TAG = "InterstitialAdsPreLoaderTAG"
    }
