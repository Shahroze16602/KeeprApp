...
class AppOpenAdManager(
    ...
    override fun load(loadListenerInternal: AdLoadListener?) {
        ...
        val request = AdRequest.Builder(adInfo.adUnitId).build()
        AppOpenAd.load(
            request,
            object : AdLoadCallback<AppOpenAd> {
                ...
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    ALog.d(
                        TAG,
                        "${adInfo.adTAG} failed to load ${adError.message}"
                    )
                    mAppOpenAdd = null
                ...
                override fun onAdLoaded(ad: AppOpenAd) {
                    ...
                    mAppOpenAdd = ad
                    loadState = AdLoadState.Loaded(this@AppOpenAdManager)
    ...
    companion object {
        ...
        private const val TAG = "Admob AppOpen"
    }
}