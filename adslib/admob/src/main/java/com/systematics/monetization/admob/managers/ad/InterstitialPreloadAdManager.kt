...
class InterstitialPreloadAdManager(
    context: Context,
    adInfo: AdInfo
        ...
        AdsPreloadManager.load(
            ...
            object : InterPreloadAdCallback {
                ...
                override fun onAdLoaded(interstitialAd: InterstitialAd) {
                    ...
                    loadState = AdLoadState.Loaded(this@InterstitialPreloadAdManager)
    ...
    companion object {
        ...
        private const val TAG = "Admob InterstitialPreload"
    }
}