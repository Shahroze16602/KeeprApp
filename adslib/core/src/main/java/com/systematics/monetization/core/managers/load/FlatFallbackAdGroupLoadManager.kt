...
internal class FlatFallbackAdGroupLoadManager(
    override val adInfoGroup: FlatFallbackAdInfoGroup,
    private val context: Context,
    private val analyticsLogger: (AdsEvents) -> Unit,
) : IAdGroupLoadManager {

    private val flatAdGroups = adInfoGroup.adUnits.toMutableList()
    ...
    override fun loadAds() {
        ...
        managerScope.launch { loadAdsInQueue(flatAdGroups) }
    }
    ...
    companion object {
        ...
        private const val TAG = "FlatFallbackAdGroupLoadManagerTAG"
    }
}